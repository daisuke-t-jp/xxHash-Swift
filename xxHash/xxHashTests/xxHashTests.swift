...
class xxHashTests: XCTestCase {
	...
	func test32OneShotWithSeed() {
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123", seed:0x7fffffff), 0xb6abf25e)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF1234", seed:0x7fffffff), 0x64118292)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF12345", seed:0x7fffffff), 0xbbb5c9a3)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456", seed:0x7fffffff), 0x723ab41f)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF1234567", seed:0x7fffffff), 0xc2ae50f3)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF12345678", seed:0x7fffffff), 0xd35fd176)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789", seed:0x7fffffff), 0x4febbc3a)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789A", seed:0x7fffffff), 0x5b4cb5b6)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789AB", seed:0x7fffffff), 0x99306dca)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABC", seed:0x7fffffff), 0x58bf5c52)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCD", seed:0x7fffffff), 0x664b141d)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDE", seed:0x7fffffff), 0x43e53f36)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF", seed:0x7fffffff), 0xdde61626)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF1", seed:0x7fffffff), 0x714805aa)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF12", seed:0x7fffffff), 0xb857fa94)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF123", seed:0x7fffffff), 0xe6e252b0)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF1234", seed:0x7fffffff), 0x1d90636a)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF12345", seed:0x7fffffff), 0x1ddcd70f)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF123456", seed:0x7fffffff), 0xb05cb3e7)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF1234567", seed:0x7fffffff), 0xd18796ab)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF12345678", seed:0x7fffffff), 0x42f4b415)
		...
		XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF123456789", seed:0x7fffffff), 0xf988dace)
	}
	...
	func test64OneShotWithSeed() {
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123", seed:0x7fffffff), 0xe0e6ea8b26e9a6c)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF1234", seed:0x7fffffff), 0x6f0cf5820cbd2945)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF12345", seed:0x7fffffff), 0xc53b26dde6f71382)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456", seed:0x7fffffff), 0xf97bb2678f244b9c)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF1234567", seed:0x7fffffff), 0xba70754ad76be81f)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF12345678", seed:0x7fffffff), 0xef8537faf7c7c182)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789", seed:0x7fffffff), 0x986070aff72bea1b)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789A", seed:0x7fffffff), 0x54bf4a755b395b5)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789AB", seed:0x7fffffff), 0x9c36e051f0ea20e)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789ABC", seed:0x7fffffff), 0x4a13510496452e3f)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789ABCD", seed:0x7fffffff), 0xd5fc2bb8b7b8d906)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789ABCDE", seed:0x7fffffff), 0x2390f5c3ff42cba2)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789ABCDEF", seed:0x7fffffff), 0x8758f66a18880d67)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789ABCDEF1", seed:0x7fffffff), 0x6a5a540379caf9a5)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789ABCDEF12", seed:0x7fffffff), 0x92b54be29186551b)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789ABCDEF123", seed:0x7fffffff), 0xfdd056a930bdf8a)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789ABCDEF1234", seed:0x7fffffff), 0xcb27b8b377efaa6c)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789ABCDEF12345", seed:0x7fffffff), 0xefe1db5b42a81c5b)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789ABCDEF123456", seed:0x7fffffff), 0x360c8e1663649507)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789ABCDEF1234567", seed:0x7fffffff), 0xc42fd82e489b804e)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789ABCDEF12345678", seed:0x7fffffff), 0x66b4dd9f9d8ea045)
		...
		XCTAssertEqual(xxHash64.digest("123456789ABCDEF123456789ABCDEF123456789", seed:0x7fffffff), 0x4b4382cf42fde13f)
	}
	...
	func test32UpdateWithSeed() {
		do {
			...
			xxh.update("4")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF1234", seed: 0x7fffffff), xxh.digest())
			xxh.update("5")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF12345", seed: 0x7fffffff), xxh.digest())
			xxh.update("6")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456", seed: 0x7fffffff), xxh.digest())
			xxh.update("7")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF1234567", seed: 0x7fffffff), xxh.digest())
			xxh.update("8")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF12345678", seed: 0x7fffffff), xxh.digest())
			xxh.update("9")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789", seed: 0x7fffffff), xxh.digest())
			xxh.update("A")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789A", seed: 0x7fffffff), xxh.digest())
			xxh.update("B")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789AB", seed: 0x7fffffff), xxh.digest())
			xxh.update("C")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABC", seed: 0x7fffffff), xxh.digest())
			xxh.update("D")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCD", seed: 0x7fffffff), xxh.digest())
			xxh.update("E")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDE", seed: 0x7fffffff), xxh.digest())
			xxh.update("F")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF", seed: 0x7fffffff), xxh.digest())
			xxh.update("1")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF1", seed: 0x7fffffff), xxh.digest())
			xxh.update("2")
			...
			xxh.update("4")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF1234", seed: 0x7fffffff), xxh.digest())
			xxh.update("5")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF12345", seed: 0x7fffffff), xxh.digest())
			xxh.update("6")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF123456", seed: 0x7fffffff), xxh.digest())
			xxh.update("7")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF1234567", seed: 0x7fffffff), xxh.digest())
			xxh.update("8")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF12345678", seed: 0x7fffffff), xxh.digest())
			xxh.update("9")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF123456789", seed: 0x7fffffff), xxh.digest())
			
			xxh.update("ABCDEF123456789ABCDEF123456789ABCDEF123456789")
			XCTAssertEqual(xxHash32.digest("123456789ABCDEF123456789ABCDEF123456789ABCDEF123456789ABCDEF123456789ABCDEF123456789", seed: 0x7fffffff), xxh.digest())
		}
