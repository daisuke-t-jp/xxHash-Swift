...
extension XXH3Common {
  ...
  static func mul128Fold64(ll1: UInt64, ll2: UInt64) -> UInt64 {
    ...
    let llh = mult32To64(h1, y: h2)
    let llm1 = mult32To64(l1, y: h2)
    let llm2 = mult32To64(h1, y: l2)
    let lll = mult32To64(l1, y: l2)
  ...
  static func accumulate512(_ acc: [UInt64], array: [UInt8], keySet: [UInt32], endian: Common.Endian) -> [UInt64] {
    var acc2 = acc
    ...
    for i in 0..<accNB {
      ...
      acc2[i] = mult32To64(UInt32(dataKey & 0xFFFFFFFF), y: UInt32(dataKey >> 32))
      acc2[i] += dataVal
    }
  ...
  static func accumulate(_ acc: [UInt64], array: [UInt8], keySet: [UInt32], nbStripes: Int, endian: Common.Endian) -> [UInt64] {
    var acc2 = acc
  ...
  static func scrambleAcc(_ acc: [UInt64], keySet: [UInt32]) -> [UInt64] {
    var acc2 = acc
